...
const LABELS: Entry[] = [
  ...
  // --- Measurement families & units (shared by unit/price comparisons) ---
  ["Weight", "ទម្ងន់"], ["Volume", "មាឌ"], ["Count", "ចំនួន"], ["Length", "ប្រវែង"],
  ...
  ["e.g. កម្ពុជា", "ឧ. កម្ពុជា"], ["Paste or type Khmer text…", "បិទភ្ជាប់ ឬវាយអត្ថបទខ្មែរ…"], ["e.g. Sokha & Dara wedding", "ឧ. មង្គលការ សុខា និង ដារ៉ា"], ["e.g. 4000", "ឧ. 4000"], ["Search a word, spoonerism, or meaning…", "ស្វែងរកពាក្យដើម ពាក្យគន្លាស់ ឬន័យពិត…"], ["e.g. ក្រមុំក្រមាច់", "ឧ. ក្រមុំក្រមាច់"], ["e.g. ក្រមាច់ពេញសុំ", "ឧ. ក្រមាច់ពេញសុំ"], ["e.g. ក្រមុំពេញសាច់", "ឧ. ក្រមុំពេញសាច់"],
