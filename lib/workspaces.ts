...
export const WORKSPACES = [
  ...
  { id: "education", label: "Education", khmer: "ការអប់រំ", keywords: ["percentage-calculator", "universal-math-workspace", "khmer-lexicon", "terminology-translator", "pangram-generator", "coeng-tada-corrector", "web-shaping-test-lab", "khmer-punctuation-restorer"] },
