...
export const WORKSPACES = [
  { id: "finance", label: "Finance", khmer: "ហិរញ្ញវត្ថុ", keywords: ["percentage-calculator", "riel-usd", "business-calculators", "vat-calculator", "currency-to-words", "loan-amortization", "payslip-generator", "salary-calculator", "nssf-payroll-calculator", "cambodia-tax", "invoice-generator", "npv-irr-calculator", "break-even-calculator", "gold-price-calculator", "inflation-calculator", "late-fee-calculator", "khmer-mixed-change", "khmer-tontine-planner"] },
