...
export const TOOLS: ToolDef[] = [
  ...
  { id: "phone-number-cleaner", title: "Phone Number Cleaner Pro", khmerTitle: "លាងលេខទូរស័ព្ទបន្ថែម", addedOn: "2026-07-30", category: "science", keywords: ["phone", "number", "cleaner", "parser", "format", "Cambodia", "cellcard", "smart", "metfone", "telegram", "whatsapp"], Component: load("science", "phone-number-cleaner") },
