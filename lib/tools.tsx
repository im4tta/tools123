...
export const TOOLS: ToolDef[] = [
  ...
  { id: "yaml-formatter", title: "YAML Formatter", khmerTitle: "រៀបចំទម្រង់ YAML", addedOn: "2026-08-27T09:00:00+07:00", category: "dev", keywords: ["yaml", "format", "beautify", "validate", "minify", "pretty", "yml", "config", "រៀបចំ YAML"], localProject: { author: "nodeca", repository: "https://github.com/nodeca/js-yaml", license: "MIT", relationship: "integrated" }, Component: load("dev", "yaml-formatter") },
  { id: "xml-formatter", title: "XML Formatter", khmerTitle: "រៀបចំទម្រង់ XML", addedOn: "2026-08-27T09:05:00+07:00", category: "dev", keywords: ["xml", "format", "beautify", "validate", "minify", "pretty", "markup", "រៀបចំ XML"], Component: load("dev", "xml-formatter") },
  { id: "code-to-image", title: "Code to Image", khmerTitle: "បម្លែងកូដទៅជារូបភាព", addedOn: "2026-08-27T09:10:00+07:00", category: "dev", keywords: ["code", "snippet", "image", "carbon", "screenshot", "share code", "png", "បម្លែងកូដ", "រូបភាព"], localProject: { author: "Niklas von Hertzen", repository: "https://github.com/niklasvh/html2canvas", license: "MIT", relationship: "integrated" }, Component: load("dev", "code-to-image") },
  { id: "sitemap-generator", title: "Sitemap Generator", khmerTitle: "បង្កើត Sitemap", addedOn: "2026-08-28T09:00:00+07:00", category: "dev", keywords: ["sitemap", "seo", "xml", "url list", "crawl", "បង្កើត sitemap"], Component: load("dev", "sitemap-generator") },
  { id: "robots-txt-generator", title: "Robots.txt Generator", khmerTitle: "បង្កើត robots.txt", addedOn: "2026-08-28T09:05:00+07:00", category: "dev", keywords: ["robots.txt", "seo", "crawl", "disallow", "user agent", "googlebot"], Component: load("dev", "robots-txt-generator") },
  { id: "rss-generator", title: "RSS Feed Generator", khmerTitle: "បង្កើត RSS Feed", addedOn: "2026-08-28T09:10:00+07:00", category: "dev", keywords: ["rss", "feed", "xml", "syndication", "blog", "atom"], Component: load("dev", "rss-generator") },
  { id: "keyboard-event-viewer", title: "Keyboard Event Viewer", khmerTitle: "កម្មវិធីមើលព្រឹត្តិការណ៍ក្ដារចុច", addedOn: "2026-08-28T12:40:00+07:00", category: "dev", keywords: ["keyboard", "keydown", "keyup", "keycode", "event", "shortcuts", "ក្តារចុច"], Component: load("dev", "keyboard-event-viewer") },
  ...
  { id: "khmer-proverbs", title: "Khmer Proverbs", khmerTitle: "សុភាសិតខ្មែរ", addedOn: "2026-08-28T09:15:00+07:00", category: "khmer", keywords: ["proverb", "សុភាសិត", "wisdom", "saying", "khmer culture", "ពាក្យពេចន៍"], Component: load("khmer", "khmer-proverbs") },
  { id: "khmer-rhyming-dictionary", title: "Khmer Rhyming Dictionary", khmerTitle: "វចនានុក្រមបទភ្លេងខ្មែរ", addedOn: "2026-08-28T09:20:00+07:00", category: "khmer", keywords: ["rhyme", "បទភ្លេង", "poetry", "វចនានុក្រម", "khmer words", "ពាក្យស្លោក"], Component: load("khmer", "khmer-rhyming-dictionary") },
  { id: "khmer-poem-generator", title: "Khmer Poem Generator (កាព្យ)", khmerTitle: "បង្កើតកាព្យខ្មែរ", addedOn: "2026-08-28T09:25:00+07:00", category: "khmer", keywords: ["poem", "កាព្យ", "poetry", "rhyme", "writer", "កំណាព្យ"], Component: load("khmer", "khmer-poem-generator") },
  ...
  { id: "heart-rate-zones", title: "Heart Rate Zones", khmerTitle: "តំបន់ចង្វាក់បេះដូង", addedOn: "2026-08-28T09:30:00+07:00", category: "science", keywords: ["heart rate", "zones", "karvonen", "max hr", "training", "bpm", "ចង្វាក់បេះដូង"], Component: load("science", "heart-rate-zones") },
  { id: "dilution-calculator", title: "Dilution & Molarity Calculator", khmerTitle: "គណនាការចម្រាញ់ និងកំរិត Molarity", addedOn: "2026-08-28T13:30:00+07:00", category: "science", keywords: ["dilution", "molarity", "c1v1", "chemistry", "solution", "ចម្រាញ់"], Component: load("science", "dilution-calculator") },
  { id: "dna-translator", title: "DNA Sequence Translator", khmerTitle: "បកប្រែលំដាប់ DNA", addedOn: "2026-08-28T13:35:00+07:00", category: "science", keywords: ["dna", "rna", "transcribe", "translate", "codon", "protein", "gc content", "biology"], Component: load("science", "dna-translator") },
  { id: "half-life-calculator", title: "Half-Life Calculator", khmerTitle: "គណនារយៈពេលពាក់កណ្តាល", addedOn: "2026-08-28T13:40:00+07:00", category: "science", keywords: ["half-life", "decay", "radioactive", "lambda", "physics", "ពាក់កណ្តាល"], Component: load("science", "half-life-calculator") },
  ...
  { id: "language-detector", title: "Language Detector", khmerTitle: "កំណត់ភាសា", addedOn: "2026-08-27T10:35:00+07:00", category: "text", keywords: ["language", "detect", "identify", "script", "khmer", "english", "heuristic", "កំណត់ភាសា"], Component: load("text", "language-detector") },
  { id: "ngram-finder", title: "N-gram Finder", khmerTitle: "ស្វែងរក N-gram", addedOn: "2026-08-27T10:40:00+07:00", category: "text", keywords: ["ngram", "n-gram", "phrase", "frequency", "word co-occurrence", "text analysis", "ស្វែងរកឃ្លា"], Component: load("text", "ngram-finder") },
  { id: "ipa-phonetics", title: "English → IPA Phonetics", khmerTitle: "បម្លែងអង់គ្លេស → IPA", addedOn: "2026-08-27T10:45:00+07:00", category: "text", keywords: ["ipa", "phonetics", "pronunciation", "transcribe", "english", "phoneme", "សូរសព្ទ"], localProject: { author: "CMU Pronouncing Dictionary", repository: "https://github.com/cmusphinx/cmudict", license: "BSD-style", relationship: "inspired" }, Component: load("text", "ipa-phonetics") },
  { id: "unicode-text-generator", title: "Unicode Text Generator", khmerTitle: "បង្កើតអត្ថបទ Unicode", addedOn: "2026-08-27T10:50:00+07:00", category: "text", keywords: ["zalgo", "fullwidth", "small caps", "unicode", "bold text", "strikethrough", "superscript", "fancy text", "បង្កើតអត្ថបទ"], Component: load("text", "unicode-text-generator") },
  ...
  { id: "bitwise-calculator", title: "Bitwise Calculator", khmerTitle: "គណនាប៊ីត", addedOn: "2026-08-27T10:10:00+07:00", category: "math", keywords: ["bitwise", "binary", "and or xor", "bit shift", "popcount", "two's complement", "hex", "ប៊ីត"], Component: load("math", "bitwise-calculator") },
  { id: "odds-converter", title: "Odds Converter", khmerTitle: "បម្លែងសមាមាត្រភ្នាល់", addedOn: "2026-08-27T10:15:00+07:00", category: "math", keywords: ["odds", "betting", "decimal odds", "fractional", "american", "implied probability", "payout", "បម្លែង odds"], Component: load("math", "odds-converter") },
  { id: "linear-regression", title: "Linear Regression", khmerTitle: "តំរែតំរង់លីនេអ៊ែរ", addedOn: "2026-08-27T10:20:00+07:00", category: "math", keywords: ["regression", "slope", "intercept", "r-squared", "best fit", "correlation", "predict", "statistics", "តំរែតំរង់"], Component: load("math", "linear-regression") },
  { id: "zscore-calculator", title: "Z-Score & Normal Distribution", khmerTitle: "Z-Score និងការចែកចាយធម្មតា", addedOn: "2026-08-27T10:25:00+07:00", category: "math", keywords: ["z-score", "normal distribution", "percentile", "probability", "erf", "statistics", "standard deviation", "z ពិន្ទុ"], Component: load("math", "zscore-calculator") },
  { id: "sequence-solver", title: "Arithmetic & Geometric Sequences", khmerTitle: "លំដាប់ស្វ័យគុណនព្វន្ត និងធរណីមាត្រ", addedOn: "2026-08-27T10:30:00+07:00", category: "math", keywords: ["sequence", "arithmetic", "geometric", "nth term", "sum", "progression", "ap", "gp", "លំដាប់លេខ"], Component: load("math", "sequence-solver") },
  { id: "margin-markup-calculator", title: "Margin & Markup Calculator", khmerTitle: "គណនាកំរិតចំណេញ និង Markup", addedOn: "2026-08-28T12:50:00+07:00", category: "math", keywords: ["margin", "markup", "profit", "price", "cost", "business"], Component: load("math", "margin-markup-calculator") },
  ...
  { id: "websocket-tester", title: "WebSocket Tester", khmerTitle: "ឧបករណ៍សាកល្បង WebSocket", addedOn: "2026-08-27T09:15:00+07:00", category: "network", keywords: ["websocket", "ws", "wss", "socket", "realtime", "test", "client", "សាកល្បង websocket"], Component: load("network", "websocket-tester") },
  { id: "punycode-converter", title: "Punycode / IDN Converter", khmerTitle: "បម្លែង Punycode / IDN", addedOn: "2026-08-27T09:20:00+07:00", category: "network", keywords: ["punycode", "idn", "unicode domain", "xn--", "internationalized domain", "encode", "decode", "បម្លែងដូមេន"], Component: load("network", "punycode-converter") },
  { id: "mac-vendor-lookup", title: "MAC Vendor Lookup", khmerTitle: "ស្វែងរកម្ចាស់ MAC", addedOn: "2026-08-27T09:25:00+07:00", category: "network", keywords: ["mac address", "oui", "vendor", "lookup", "ethernet", "wifi", "device", "ស្វែងរក MAC"], localProject: { author: "IEEE OUI registry", repository: "https://standards.ieee.org/products-programs/regauth/oui/", license: "IEEE registry (public data)", relationship: "inspired" }, Component: load("network", "mac-vendor-lookup") },
  { id: "download-time-calculator", title: "Download Time Calculator", khmerTitle: "គណនាពេលទាញយក", addedOn: "2026-08-28T12:55:00+07:00", category: "network", keywords: ["download", "speed", "time", "file size", "bandwidth", "transfer", "ពេលទាញយក"], Component: load("network", "download-time-calculator") },
  { id: "ipv6-subnet-calculator", title: "IPv6 Subnet Calculator", khmerTitle: "គណនា Subnet IPv6", addedOn: "2026-08-28T13:05:00+07:00", category: "network", keywords: ["ipv6", "subnet", "prefix", "128-bit", "rfc 4291", "rfc 5952"], Component: load("network", "ipv6-subnet-calculator") },
  ...
  { id: "hash-identifier", title: "Hash Identifier", khmerTitle: "កំណត់ប្រភេទ Hash", addedOn: "2026-08-27T09:30:00+07:00", category: "security", keywords: ["hash", "identify", "detect", "md5", "sha", "bcrypt", "argon2", "ntlm", "crc32", "type", "កំណត់ hash"], Component: load("security", "hash-identifier") },
  { id: "email-header-analyzer", title: "Email Header Analyzer", khmerTitle: "វិភាគបឋមកថាអ៊ីមែល", addedOn: "2026-08-27T09:35:00+07:00", category: "security", keywords: ["email header", "received", "spf", "dkim", "dmarc", "phishing", "authentication-results", "trace", "វិភាគអ៊ីមែល"], Component: load("security", "email-header-analyzer") },
  { id: "totp-authenticator", title: "TOTP / 2FA Authenticator", khmerTitle: "កម្មវិធីផ្ទៀងផ្ទាត់ TOTP", addedOn: "2026-08-27T09:40:00+07:00", category: "security", keywords: ["totp", "hotp", "2fa", "mfa", "authenticator", "otp", "one time password", "rfc 6238", "ផ្ទៀងផ្ទាត់ពីរជំហាន"], Component: load("security", "totp-authenticator") },
  { id: "aes-encryption", title: "AES Encrypt / Decrypt", khmerTitle: "អ៊ិនគ្រីប / ឌិគ្រីប AES", addedOn: "2026-08-27T09:45:00+07:00", category: "security", keywords: ["aes", "gcm", "encrypt", "decrypt", "pbkdf2", "cipher", "webcrypto", "symmetric", "អ៊ិនគ្រីប"], Component: load("security", "aes-encryption") },
  { id: "rsa-key-generator", title: "RSA Key Pair Generator", khmerTitle: "បង្កើតសោ RSA", addedOn: "2026-08-27T09:50:00+07:00", category: "security", keywords: ["rsa", "key pair", "public key", "private key", "pem", "generate", "2048", "4096", "បង្កើតសោ"], Component: load("security", "rsa-key-generator") },
  { id: "base58-codec", title: "Base58 Encoder / Decoder", khmerTitle: "អ៊ិនកូដ Base58", addedOn: "2026-08-27T09:55:00+07:00", category: "security", keywords: ["base58", "bitcoin", "crypto wallet", "encode", "decode", "base58check", "checksum", "អ៊ិនកូដ"], Component: load("security", "base58-codec") },
  { id: "certificate-viewer", title: "Certificate (X.509) Viewer", khmerTitle: "មើលវិញ្ញាបនបត្រ X.509", addedOn: "2026-08-27T10:00:00+07:00", category: "security", keywords: ["certificate", "x509", "pem", "ssl", "tls", "der", "subject", "issuer", "validity", "វិញ្ញាបនបត្រ"], Component: load("security", "certificate-viewer") },
  { id: "pwned-check", title: "Password Breach Check", khmerTitle: "ពិនិត្យពាក្យសម្ងាត់លេចធ្លាយ", addedOn: "2026-08-27T10:05:00+07:00", category: "security", keywords: ["pwned", "breach", "haveibeenpwned", "password check", "leak", "hibp", "compromised", "ពាក្យសម្ងាត់លេចធ្លាយ"], localProject: { author: "Troy Hunt", repository: "https://haveibeenpwned.com/", license: "CC BY-NC-4.0", relationship: "integrated" }, Component: load("security", "pwned-check") },
  ...
  { id: "glassmorphism-generator", title: "Glassmorphism Generator", khmerTitle: "បង្កើត Glassmorphism", addedOn: "2026-08-27T10:55:00+07:00", category: "design", keywords: ["glassmorphism", "glass", "blur", "backdrop-filter", "transparency", "frosted", "css", "បង្កើតកញ្ចក់"], Component: load("design", "glassmorphism-generator") },
  { id: "neumorphism-generator", title: "Neumorphism Generator", khmerTitle: "បង្កើត Neumorphism", addedOn: "2026-08-27T11:00:00+07:00", category: "design", keywords: ["neumorphism", "soft ui", "box shadow", "inset", "skeuomorphism", "css", "បង្កើត Neumorphism"], Component: load("design", "neumorphism-generator") },
  { id: "text-shadow-generator", title: "Text Shadow Generator", khmerTitle: "បង្កើតស្រមោលអត្ថបទ", addedOn: "2026-08-27T11:05:00+07:00", category: "design", keywords: ["text shadow", "css", "shadow", "layers", "typography", "effect", "ស្រមោលអត្ថបទ"], Component: load("design", "text-shadow-generator") },
  { id: "css-filter-generator", title: "CSS Filter Generator", khmerTitle: "បង្កើត CSS Filter", addedOn: "2026-08-27T11:10:00+07:00", category: "design", keywords: ["css filter", "grayscale", "sepia", "saturate", "hue-rotate", "blur", "brightness", "image effect", "តម្រងរូប"], Component: load("design", "css-filter-generator") },
  { id: "font-pair-finder", title: "Font Pair Finder", khmerTitle: "ស្វែងរក Font ផ្គូផ្គង", addedOn: "2026-08-27T11:15:00+07:00", category: "design", keywords: ["font pairing", "google fonts", "typography", "heading", "body", "combinations", "fonts", "ស្វែងរក font"], Component: load("design", "font-pair-finder") },
  { id: "css-grid-playground", title: "CSS Grid Playground", khmerTitle: "ទីលានសាកល្បង CSS Grid", addedOn: "2026-08-27T11:20:00+07:00", category: "design", keywords: ["css grid", "grid", "layout", "playground", "template columns", "gap", "justify", "align", "សាកល្បង grid"], Component: load("design", "css-grid-playground") },
  { id: "svg-path-inspector", title: "SVG Path Inspector", khmerTitle: "ពិនិត្យ SVG Path", addedOn: "2026-08-27T11:25:00+07:00", category: "design", keywords: ["svg", "path", "d attribute", "vector", "command", "bezier", "inspect", "ពិនិត្យ svg"], Component: load("design", "svg-path-inspector") },
  { id: "svg-pattern-generator", title: "SVG Pattern Generator", khmerTitle: "បង្កើត SVG Pattern", addedOn: "2026-08-27T11:30:00+07:00", category: "design", keywords: ["svg pattern", "pattern", "dots", "stripes", "grid", "checkerboard", "crosshatch", "texture", "បង្កើត pattern"], Component: load("design", "svg-pattern-generator") },
  { id: "graph-visualizer", title: "Graph Visualizer", khmerTitle: "បង្ហាញក្រាហ្វទំនាក់ទំនង", addedOn: "2026-08-27T11:35:00+07:00", category: "design", keywords: ["graph", "network", "force directed", "nodes", "edges", "d3", "visualization", "relation", "ក្រាហ្វទំនាក់ទំនង"], localProject: { author: "Mike Bostock", repository: "https://github.com/d3/d3", license: "ISC", relationship: "integrated" }, Component: load("design", "graph-visualizer") },
  { id: "resume-builder", title: "Resume / CV Builder", khmerTitle: "បង្កើត CV", addedOn: "2026-08-27T11:40:00+07:00", category: "design", keywords: ["resume", "cv", "curriculum vitae", "builder", "print", "a4", "job application", "បង្កើត CV"], Component: load("design", "resume-builder") },
  { id: "css-animation-generator", title: "CSS Animation Generator", khmerTitle: "បង្កើត Animation CSS", addedOn: "2026-08-28T12:35:00+07:00", category: "design", keywords: ["css", "animation", "keyframes", "easing", "cubic-bezier", "transitions"], Component: load("design", "css-animation-generator") },
  ...
  { id: "git-cheatsheet", title: "Git Cheat Sheet", khmerTitle: "សន្លឹកយោង Git", addedOn: "2026-08-28T09:35:00+07:00", category: "knowledge", keywords: ["git", "cheatsheet", "commands", "branch", "commit", "reference", "សន្លឹកយោង"], Component: load("knowledge", "git-cheatsheet") },
  { id: "html-css-cheatsheet", title: "HTML & CSS Cheat Sheet", khmerTitle: "សន្លឹកយោង HTML និង CSS", addedOn: "2026-08-28T09:40:00+07:00", category: "knowledge", keywords: ["html", "css", "cheatsheet", "tags", "selectors", "reference", "សន្លឹកយោង"], Component: load("knowledge", "html-css-cheatsheet") },
  { id: "sql-cheatsheet", title: "SQL Cheat Sheet", khmerTitle: "សន្លឹកយោង SQL", addedOn: "2026-08-28T09:45:00+07:00", category: "knowledge", keywords: ["sql", "database", "query", "cheatsheet", "join", "reference", "សន្លឹកយោង"], Component: load("knowledge", "sql-cheatsheet") },
  { id: "linux-cheatsheet", title: "Linux Command Cheat Sheet", khmerTitle: "សន្លឹកយោង Linux", addedOn: "2026-08-28T09:50:00+07:00", category: "knowledge", keywords: ["linux", "terminal", "commands", "bash", "cheatsheet", "reference", "សន្លឹកយោង"], Component: load("knowledge", "linux-cheatsheet") },
  { id: "country-dialing-codes", title: "Country Dialing Codes", khmerTitle: "លេខកូដទូរស័ព្ទអន្តរជាតិ", addedOn: "2026-08-28T09:55:00+07:00", category: "knowledge", keywords: ["country code", "calling code", "phone", "international", "dialing", "e.164"], Component: load("knowledge", "country-dialing-codes") },
  { id: "currency-codes", title: "Currency Codes (ISO 4217)", khmerTitle: "លេខកូដរូបិយប័ណ្ណ", addedOn: "2026-08-28T10:00:00+07:00", category: "knowledge", keywords: ["currency", "iso 4217", "code", "exchange", "symbol", "រូបិយប័ណ្ណ"], Component: load("knowledge", "currency-codes") },
  { id: "food-calorie-reference", title: "Food Calorie Reference", khmerTitle: "ឯកសារយោងកាឡូរីអាហារ", addedOn: "2026-08-28T10:05:00+07:00", category: "knowledge", keywords: ["calories", "food", "nutrition", "kcal", "diet", "កាឡូរី"], Component: load("knowledge", "food-calorie-reference") },
  { id: "sample-size-calculator", title: "Sample Size Calculator", khmerTitle: "គណនាទំហំគំរូ", addedOn: "2026-08-28T12:45:00+07:00", category: "knowledge", keywords: ["sample size", "survey", "margin of error", "cochran", "statistics", "research"], Component: load("knowledge", "sample-size-calculator") },
  ...
  { id: "concrete-calculator", title: "Concrete Calculator", khmerTitle: "គណនាបេតុង", addedOn: "2026-08-27T11:45:00+07:00", category: "office", keywords: ["concrete", "cement", "sand", "gravel", "mix ratio", "slab", "footing", "volume", "បេតុង", "ស៊ីម៉ង់ត៍"], Component: load("office", "concrete-calculator") },
  { id: "rebar-calculator", title: "Rebar Weight Calculator", khmerTitle: "គណនាទម្ងន់ដែក", addedOn: "2026-08-27T11:50:00+07:00", category: "office", keywords: ["rebar", "steel", "bar weight", "reinforcement", "astm", "diameter", "construction", "ដែក"], Component: load("office", "rebar-calculator") },
  { id: "tile-calculator", title: "Tile Calculator", khmerTitle: "គណនាក្បឿង", addedOn: "2026-08-27T11:55:00+07:00", category: "office", keywords: ["tile", "floor", "wall", "area", "quantity", "wastage", "boxes", "ក្បឿង"], Component: load("office", "tile-calculator") },
  { id: "solar-calculator", title: "Solar Panel Sizing", khmerTitle: "គណនាប្រព័ន្ធពន្លឺព្រះអាទិត្យ", addedOn: "2026-08-27T12:00:00+07:00", category: "office", keywords: ["solar", "panel", "battery", "inverter", "kwh", "off grid", "system sizing", "ពន្លឺព្រះអាទិត្យ"], Component: load("office", "solar-calculator") },
  { id: "ac-btu-calculator", title: "AC / BTU Room Cooling", khmerTitle: "គណនា BTU ម៉ាស៊ីនត្រជាក់", addedOn: "2026-08-27T12:05:00+07:00", category: "office", keywords: ["ac", "air conditioner", "btu", "cooling", "room size", "kw", "hp", "ម៉ាស៊ីនត្រជាក់"], Component: load("office", "ac-btu-calculator") },
  { id: "generator-sizing", title: "Generator Sizing", khmerTitle: "គណនាទំហំម៉ាស៊ីនភ្លើង", addedOn: "2026-08-27T12:10:00+07:00", category: "office", keywords: ["generator", "sizing", "wattage", "kva", "kw", "surge", "standby power", "ម៉ាស៊ីនភ្លើង"], Component: load("office", "generator-sizing") },
  { id: "gold-price-calculator", title: "Gold Price Calculator (Cambodia)", khmerTitle: "គណនាតម្លៃមាសកម្ពុជា", addedOn: "2026-08-27T12:15:00+07:00", category: "office", keywords: ["gold", "price", "chi", "ជី", "gram", "troy ounce", "24k", "22k", "18k", "cambodia", "មាស"], Component: load("office", "gold-price-calculator") },
  { id: "recipe-resizer", title: "Recipe Resizer", khmerTitle: "កែទំហំរូបមន្ត", addedOn: "2026-08-28T10:10:00+07:00", category: "office", keywords: ["recipe", "scale", "servings", "cooking", "ingredients", "រូបមន្ត"], Component: load("office", "recipe-resizer") },
  { id: "coffee-ratio", title: "Coffee Ratio Calculator", khmerTitle: "គណនាសមាមាត្រកាហ្វេ", addedOn: "2026-08-28T10:15:00+07:00", category: "office", keywords: ["coffee", "ratio", "brew", "pour over", "espresso", "កាហ្វេ"], Component: load("office", "coffee-ratio") },
  { id: "depreciation-calculator", title: "Depreciation Calculator", khmerTitle: "គណនាការធ្លាក់តម្លៃសម្បត្តិ", addedOn: "2026-08-28T13:10:00+07:00", category: "office", keywords: ["depreciation", "asset", "straight-line", "declining balance", "double declining", "sum-of-years"], Component: load("office", "depreciation-calculator") },
  { id: "meeting-cost-calculator", title: "Meeting Cost Calculator", khmerTitle: "គណនាចំណាយការប្រជុំ", addedOn: "2026-08-28T13:15:00+07:00", category: "office", keywords: ["meeting", "cost", "salary", "hourly rate", "time", "productivity", "ចំណាយប្រជុំ"], Component: load("office", "meeting-cost-calculator") },
  { id: "npv-irr-calculator", title: "NPV & IRR Calculator", khmerTitle: "គណនា NPV និង IRR", addedOn: "2026-08-28T13:20:00+07:00", category: "office", keywords: ["npv", "irr", "discounted cash flow", "payback", "investment", "finance", "ចរន្តសាច់ប្រាក់"], Component: load("office", "npv-irr-calculator") },
  { id: "volumetric-weight-calculator", title: "Volumetric Weight Calculator", khmerTitle: "គណនាទម្ងន់តាមទំហំ", addedOn: "2026-08-28T13:25:00+07:00", category: "office", keywords: ["volumetric weight", "dimensional weight", "shipping", "courier", "chargeable", "ទម្ងន់តាមទំហំ"], Component: load("office", "volumetric-weight-calculator") },
  ...
  { id: "image-collage", title: "Image Collage Maker", khmerTitle: "បង្កើតរូបភាពផ្សំគ្នា", addedOn: "2026-08-28T10:20:00+07:00", category: "images", keywords: ["collage", "photo grid", "combine images", "layout", "grid", "png", "ផ្សំរូប"], Component: load("images", "image-collage") },
  { id: "image-vectorizer", title: "Image → SVG Vectorizer", khmerTitle: "បម្លែងរូបទៅជា SVG", addedOn: "2026-08-28T10:25:00+07:00", category: "images", keywords: ["vectorize", "svg", "trace", "image to svg", "marching squares", "outline", "បម្លែង SVG"], Component: load("images", "image-vectorizer") },
  { id: "placeholder-image", title: "Placeholder Image Generator", khmerTitle: "បង្កើតរូបភាព Placeholder", addedOn: "2026-08-28T10:30:00+07:00", category: "images", keywords: ["placeholder", "dummy image", "svg", "mockup", "dimensions", "បង្កើតរូបភាព"], Component: load("images", "placeholder-image-generator") },
  { id: "gif-splitter", title: "GIF Splitter / Speed Changer", khmerTitle: "បំបែក GIF / ប្តូរល្បឿន", addedOn: "2026-08-28T10:35:00+07:00", category: "images", keywords: ["gif", "split", "frames", "speed", "slow motion", "edit gif", "lzw", "បំបែក gif"], localProject: { author: "Johan Nordberg", repository: "https://github.com/jnordberg/gif.js", license: "MIT", relationship: "integrated" }, Component: load("images", "gif-splitter") },
  { id: "barcode-reader", title: "Barcode Reader (EAN/UPC)", khmerTitle: "អាន Barcode (EAN/UPC)", addedOn: "2026-08-28T10:40:00+07:00", category: "images", keywords: ["barcode", "ean", "upc", "scan", "decode", "product code", "អាន barcode"], Component: load("images", "barcode-reader") },
  { id: "image-histogram", title: "Image Histogram", khmerTitle: "អ៊ីស្តូក្រាមរូបភាព", addedOn: "2026-08-28T10:45:00+07:00", category: "images", keywords: ["histogram", "exposure", "rgb", "luminance", "photo analysis", "អ៊ីស្តូក្រាម"], Component: load("images", "image-histogram") },
  { id: "pixel-art", title: "Pixel Art Generator", khmerTitle: "បង្កើតសិល្បៈ Pixel", addedOn: "2026-08-28T10:50:00+07:00", category: "images", keywords: ["pixel art", "8-bit", "pixelate", "sprite", "quantize", "retro", "សិល្បៈ pixel"], Component: load("images", "pixel-art-generator") },
  ...
  { id: "audio-merger", title: "Audio Merger / Converter", khmerTitle: "បញ្ចូលសំឡេង / បម្លែង", addedOn: "2026-08-28T10:55:00+07:00", category: "audio", keywords: ["audio", "merge", "combine", "concatenate", "wav", "convert", "បញ្ចូលសំឡេង"], Component: load("audio", "audio-merger") },
  { id: "tempo-changer", title: "Tempo & Pitch Changer", khmerTitle: "ប្តូរចង្វាក់ និងកម្រិតសំឡេង", addedOn: "2026-08-28T11:00:00+07:00", category: "audio", keywords: ["tempo", "pitch", "speed", "playback rate", "detune", "audio", "ចង្វាក់"], Component: load("audio", "tempo-changer") },
  { id: "noise-generator", title: "Noise Generator", khmerTitle: "បង្កើតសំឡេង Noise", addedOn: "2026-08-28T11:05:00+07:00", category: "audio", keywords: ["white noise", "pink noise", "brown noise", "sleep sounds", "generator", "wav", "សំឡេង noise"], Component: load("audio", "noise-generator") },
  { id: "virtual-piano", title: "Virtual Piano & Chords", khmerTitle: "ព្យាណូ និង Chord", addedOn: "2026-08-28T11:10:00+07:00", category: "audio", keywords: ["piano", "keyboard", "chords", "music", "synth", "play", "ព្យាណូ"], Component: load("audio", "virtual-piano") },
  { id: "stereo-channel-test", title: "Stereo Channel Test", khmerTitle: "សាកល្បងសំឡេងឆានែល", addedOn: "2026-08-28T12:30:00+07:00", category: "audio", keywords: ["stereo", "channel", "left right", "balance", "speaker test", "សំឡេងឆានែល"], Component: load("audio", "stereo-channel-test") },
  ...
  { id: "video-compressor", title: "Video Compressor", khmerTitle: "បង្រួមវីដេអូ", addedOn: "2026-08-28T11:15:00+07:00", category: "video", keywords: ["video", "compress", "reduce size", "webm", "bitrate", "resolution", "បង្រួមវីដេអូ"], Component: load("video", "video-compressor") },
  { id: "subtitle-editor", title: "Subtitle Editor (SRT/VTT)", khmerTitle: "កែសម្រួលអក្សររត់", addedOn: "2026-08-28T11:20:00+07:00", category: "video", keywords: ["subtitle", "srt", "vtt", "caption", "editor", "offset", "អក្សររត់"], Component: load("video", "subtitle-editor") },
  ...
  { id: "device-info", title: "Device Info", khmerTitle: "ព័ត៌មានឧបករណ៍", addedOn: "2026-08-28T13:00:00+07:00", category: "meta", keywords: ["device", "browser", "screen", "battery", "memory", "user agent", "hardware", "ព័ត៌មានឧបករណ៍"], Component: load("meta", "device-info") },
  ...
  { id: "period-tracker", title: "Period & Ovulation Tracker", khmerTitle: "តាមដានវដ្តរដូវ", addedOn: "2026-08-28T11:25:00+07:00", category: "family", keywords: ["period", "menstrual cycle", "ovulation", "fertile window", "tracker", "វដ្តរដូវ"], Component: load("family", "period-tracker") },
  { id: "fasting-timer", title: "Intermittent Fasting Timer", khmerTitle: "ម៉ោងតមអាហារ", addedOn: "2026-08-28T11:30:00+07:00", category: "family", keywords: ["fasting", "intermittent fasting", "timer", "16:8", "health", "តមអាហារ"], Component: load("family", "fasting-timer") },
  ...
  { id: "sudoku", title: "Sudoku", khmerTitle: "ល្បែងស៊ូដូគូ", addedOn: "2026-08-28T11:35:00+07:00", category: "fun", keywords: ["sudoku", "puzzle", "logic", "numbers", "game", "ស៊ូដូគូ"], Component: load("fun", "sudoku") },
  { id: "trivia-quiz", title: "Trivia Quiz", khmerTitle: "ល្បែងសំណួរចំណេះទូទៅ", addedOn: "2026-08-28T11:40:00+07:00", category: "fun", keywords: ["trivia", "quiz", "questions", "general knowledge", "game", "សំណួរ"], Component: load("fun", "trivia-quiz") },
  { id: "bingo-generator", title: "Bingo Card Generator", khmerTitle: "បង្កើតកាតប៊ីងហ្គូ", addedOn: "2026-08-28T11:45:00+07:00", category: "fun", keywords: ["bingo", "cards", "game", "printable", "party", "ប៊ីងហ្គូ"], Component: load("fun", "bingo-generator") },
  { id: "cambodia-geography-quiz", title: "Cambodia Geography Quiz", khmerTitle: "ល្បែងភូមិសាស្ត្រកម្ពុជា", addedOn: "2026-08-28T11:50:00+07:00", category: "fun", keywords: ["cambodia", "geography", "province", "capital", "quiz", "ភូមិសាស្ត្រកម្ពុជា"], Component: load("fun", "cambodia-geography-quiz") },
