...
export const TOOLS: ToolDef[] = [
  ...
  { id: "pangram-generator", title: "Khmer Pangram & Character Coverage Generator", khmerTitle: "កម្មវិធីបង្កើត Pangram និងពិនិត្យគ្របដណ្តប់តួអក្សរខ្មែរ", addedOn: "2026-08-05T17:00:00+07:00", category: "khmer", keywords: ["pangram", "character coverage", "font testing", "khmer unicode", "consonants", "subscripts", "vowels", "typography", "តួអក្សរ", "ព្យញ្ជនៈ", "ស្រៈ"], Component: load("khmer", "pangram-generator") },
  ...
  { id: "terminology-coverage", title: "Khmer Terminology Coverage Checker", khmerTitle: "ពិនិត្យការគ្របដណ្តប់ពាក្យបច្ចេកទេសខ្មែរ", addedOn: "2026-08-05T13:00:00+07:00", category: "khmer", keywords: ["terminology", "coverage", "mptc", "glossary", "technical terms"], Component: load("khmer", "terminology-coverage") },
  { id: "terminology-translator", title: "Khmer ↔ Digital Terminology Translator", khmerTitle: "កម្មវិធីបកប្រែវាក្យស័ព្ទឌីជីថល ខ្មែរ ↔ អង់គ្លេស", addedOn: "2026-08-05T14:00:00+07:00", category: "khmer", keywords: ["terminology translator", "mptc", "official terms", "digital terminology", "khmer translation", "វាក្យស័ព្ទ", "បកប្រែបច្ចេកទេស"], Component: load("khmer", "terminology-translator") },
  { id: "document-terminology-scanner", title: "Khmer Document Terminology Scanner", khmerTitle: "ស្កេនពាក្យបច្ចេកទេសក្នុងឯកសារ", addedOn: "2026-08-05T15:00:00+07:00", category: "khmer", keywords: ["document", "pdf", "docx", "txt", "terminology", "scanner", "report", "occurrences"], Component: load("khmer", "document-terminology-scanner") },
  { id: "dataset-profiler", title: "Khmer Dataset Profiler", khmerTitle: "វិភាគគុណភាព Dataset ខ្មែរ", addedOn: "2026-08-05T16:00:00+07:00", category: "khmer", keywords: ["dataset", "csv", "json", "duplicates", "unicode", "language statistics", "missing values", "normalize", "deduplicate"], Component: load("khmer", "dataset-profiler") },
  ...
  { id: "font-coverage-analyzer", title: "Khmer Font Coverage Analyzer", khmerTitle: "វិភាគការគាំទ្រអក្សរខ្មែរ ក្នុង Font", addedOn: "2026-08-05T18:00:00+07:00", category: "khmer", keywords: ["font", "ttf", "otf", "glyph", "coverage", "khmer", "unicode block", "consonants", "subscripts", "vowels", "punctuation"], Component: load("khmer", "font-coverage-analyzer") },
  { id: "web-shaping-test-lab", title: "Khmer Web Shaping Test Lab", khmerTitle: "មន្ទីរពិសោធន៍សាកល្បងការបង្ហាញអក្សរខ្មែរ", addedOn: "2026-08-05T20:00:00+07:00", category: "khmer", keywords: ["font", "shaping", "khmer", "coeng", "vowels", "browser", "chrome", "firefox", "safari", "typography", "OpenType"], Component: load("khmer", "web-shaping-test-lab") },
  ...
  { id: "coeng-tada-corrector", title: "Khmer Coeng Ta/Da Corrector", khmerTitle: "កែសម្រួលជើង ត / ជើង ដ", addedOn: "2026-08-05T19:00:00+07:00", category: "khmer", keywords: ["coeng", "tada", "ta", "da", "khmer spelling", "orthography", "wasm", "unicode", "ជើងត", "ជើងដ"], localProject: { author: "Seanghay Yath", repository: "https://github.com/seanghay/khmer-coeng-tada-corrector", license: "MIT" }, Component: load("khmer", "coeng-tada-corrector") },
  ...
  { id: "khmer-punctuation-restorer", title: "Khmer Sentence Punctuation Restorer", khmerTitle: "កែសម្រួលវណ្ណយុត្តិប្រយោគខ្មែរ", addedOn: "2026-08-05T21:00:00+07:00", category: "khmer", keywords: ["punctuation", "restore", "ocr", "asr", "scraped text", "old documents", "khmerpunctuate", "វណ្ណយុត្តិ"], localProject: { author: "Seanghay Yath", repository: "https://github.com/seanghay/khmerpunctuate", license: "MIT", relationship: "inspired" }, Component: load("khmer", "khmer-punctuation-restorer") },
  ...
  { id: "calculation-notebook", title: "Calculation Notebook", khmerTitle: "សៀវភៅកត់ត្រាការគណនា", addedOn: "2026-08-05T12:30:00+07:00", category: "office", keywords: ["calculation notebook", "live calculation", "project", "estimate", "construction", "paint", "quantity takeoff", "dependencies", "សៀវភៅគណនា"], Component: load("office", "calculation-notebook") },
