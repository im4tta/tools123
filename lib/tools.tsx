...
export const TOOLS: ToolDef[] = [
  ...
  { id: "deepseek-rate-desk", title: "DeepSeek V4 Rate Desk", khmerTitle: "តារាងតម្លៃ DeepSeek V4", addedOn: "2026-08-21T15:00:00+07:00", category: "dev", keywords: ["deepseek", "pricing", "api", "rate", "token cost", "llm", "peak", "off-peak", "cost calculator", "deepseek v4", "តម្លៃ"], Component: load("dev", "deepseek-rate-desk") },
  ...
  { id: "electronics-calculators", title: "Electronics Calculators", khmerTitle: "ម៉ាស៊ីនគណនាអេឡិចត្រូនិក", addedOn: "2026-08-21T13:00:00+07:00", category: "science", keywords: ["resistor", "color code", "led", "voltage divider", "ohms law", "electronics", "circuit", "ohm", "រេស៊ីស្ទ័រ", "អេឡិចត្រូនិក"], Component: load("science", "electronics-calculators") },
  { id: "one-rep-max", title: "One-Rep Max (1RM) Calculator", khmerTitle: "គណនាទម្ងន់អតិបរមា ១ដង (1RM)", addedOn: "2026-08-21T13:05:00+07:00", category: "science", keywords: ["1rm", "one rep max", "epley", "brzycki", "strength", "lifting", "gym", "weightlifting", "fitness", "លើកទម្ងន់"], Component: load("science", "one-rep-max") },
  ...
  { id: "math-symbols", title: "Math Symbol Dictionary", khmerTitle: "វចនានុក្រមសញ្ញាគណិតវិទ្យា", addedOn: "2026-08-21T12:00:00+07:00", category: "math", keywords: ["math symbols", "symbol", "latex", "unicode", "summation", "integral", "greek letters", "notation", "សញ្ញាគណិតវិទ្យា"], Component: load("math", "math-symbols") },
  { id: "formula-solver", title: "Formula Solver", khmerTitle: "ដោះស្រាយរូបមន្ត", addedOn: "2026-08-21T12:05:00+07:00", category: "math", keywords: ["formula", "solve", "area", "volume", "speed", "density", "ohms law", "pythagorean", "interest", "រូបមន្ត"], Component: load("math", "formula-solver") },
  { id: "permutation-combination", title: "Permutation & Combination Calculator", khmerTitle: "គណនាការរៀបលំដាប់ និងបន្សំ", addedOn: "2026-08-21T12:10:00+07:00", category: "math", keywords: ["permutation", "combination", "npr", "ncr", "factorial", "combinatorics", "choose"], Component: load("math", "permutation-combination") },
  { id: "complex-number", title: "Complex Number Calculator", khmerTitle: "គណនាចំនួនកុំផ្លិច", addedOn: "2026-08-21T12:15:00+07:00", category: "math", keywords: ["complex number", "imaginary", "a+bi", "modulus", "argument", "conjugate", "កុំផ្លិច"], Component: load("math", "complex-number") },
  { id: "geometry-calculator", title: "Geometry Area & Volume Calculator", khmerTitle: "គណនាផ្ទៃក្រឡា និងមាឌធរណីមាត្រ", addedOn: "2026-08-21T12:20:00+07:00", category: "math", keywords: ["area", "volume", "perimeter", "surface area", "circle", "sphere", "cylinder", "cone", "cube", "geometry"], Component: load("math", "geometry-calculator") },
  { id: "exponent-logarithm", title: "Exponent & Logarithm Solver", khmerTitle: "ដោះស្រាយស្វ័យគុណ និងលោការីត", addedOn: "2026-08-21T12:25:00+07:00", category: "math", keywords: ["exponent", "logarithm", "log", "power", "base", "e", "ln", "ស្វ័យគុណ", "លោការីត"], Component: load("math", "exponent-logarithm") },
  { id: "trig-values", title: "Trig Values Table", khmerTitle: "តារាងតម្លៃត្រីកោណមាត្រ", addedOn: "2026-08-21T12:30:00+07:00", category: "math", keywords: ["trig", "trigonometry", "sin", "cos", "tan", "unit circle", "radians", "degrees", "ត្រីកោណមាត្រ"], Component: load("math", "trig-values") },
  { id: "matrix-operations", title: "Matrix Operations Calculator", khmerTitle: "គណនាប្រតិបត្តិការម៉ាទ្រីស", addedOn: "2026-08-21T13:10:00+07:00", category: "math", keywords: ["matrix", "matrices", "add", "multiply", "inverse", "transpose", "determinant", "linear algebra", "ម៉ាទ្រីស"], Component: load("math", "matrix-operations") },
  { id: "vector-calculator", title: "Vector Calculator", khmerTitle: "ម៉ាស៊ីនគណនាវ៉ិចទ័រ", addedOn: "2026-08-21T14:00:00+07:00", category: "math", keywords: ["vector", "dot product", "cross product", "magnitude", "angle", "projection", "វ៉ិចទ័រ"], Component: load("math", "vector-calculator") },
  ...
  { id: "social-post-generator", title: "Social Post Generator", khmerTitle: "បង្កើតប៉ុស្តិ៍បណ្ដាញសង្គម", addedOn: "2026-08-21T14:30:00+07:00", category: "design", keywords: ["social post", "social media", "x", "twitter", "facebook", "telegram", "instagram", "story", "post image", "quote card", "social graphic", "បង្កើតប៉ុស្តិ៍", "បណ្ដាញសង្គម"], Component: load("design", "social-post-generator") },
  ...
  { id: "barcode-generator", title: "Barcode Generator", khmerTitle: "បង្កើតកូដបារកូដ", addedOn: "2026-08-21T14:05:00+07:00", category: "office", keywords: ["barcode", "ean", "upc", "code128", "code39", "svg", "retail", "inventory", "បារកូដ"], Component: load("office", "barcode-generator") },
  { id: "inflation-calculator", title: "Inflation Calculator", khmerTitle: "គណនាអតិផរណា", addedOn: "2026-08-21T14:10:00+07:00", category: "office", keywords: ["inflation", "purchasing power", "cpi", "price", "money", "economy", "អតិផរណា"], Component: load("office", "inflation-calculator") },
  { id: "excel-password-remover", title: "Excel Password Remover", khmerTitle: "ឧបករណ៍ដកពាក្យសម្ងាត់ Excel", addedOn: "2026-08-21T15:30:00+07:00", category: "office", keywords: ["excel", "password", "unprotect", "remove protection", "sheet protection", "workbook protection", "xlsx", "xlsm", "unlock", "ពាក្យសម្ងាត់"], Component: load("office", "excel-password-remover") },
  { id: "webcam-mic-test", title: "Webcam & Microphone Test", khmerTitle: "ពិសោធន៍កាមេរ៉ា និងមីក្រូហ្វូន", addedOn: "2026-08-21T16:00:00+07:00", category: "video", keywords: ["webcam", "camera", "microphone", "mic test", "device test", "level meter", "កាមេរ៉ា", "មីក្រូហ្វូន"], Component: load("video", "webcam-mic-test") },
  { id: "screen-recorder", title: "Screen Recorder", khmerTitle: "ការថតអេក្រង់", addedOn: "2026-08-21T16:05:00+07:00", category: "video", keywords: ["screen recorder", "record screen", "webm", "capture", "screencast", "ថតអេក្រង់"], Component: load("video", "screen-recorder") },
  { id: "screen-color-picker", title: "Screen Color Picker", khmerTitle: "កម្មវិធីជ្រើសរើសពណ៌អេក្រង់", addedOn: "2026-08-21T16:10:00+07:00", category: "design", keywords: ["color picker", "eyedropper", "pick color", "hex", "rgb", "hsl", "ជ្រើសពណ៌"], Component: load("design", "screen-color-picker") },
  { id: "periodic-table", title: "Periodic Table & Molar Mass", khmerTitle: "តារាងខួប និងម៉ាសម៉ូលា", addedOn: "2026-08-21T16:15:00+07:00", category: "science", keywords: ["periodic table", "elements", "chemistry", "molar mass", "formula", "atomic", "តារាងខួប", "គីមី"], Component: load("science", "periodic-table") },
  { id: "word-cloud", title: "Word Cloud Generator", khmerTitle: "បង្កើតពពកពាក្យ", addedOn: "2026-08-21T16:20:00+07:00", category: "fun", keywords: ["word cloud", "tag cloud", "text visualization", "frequency", "ពពកពាក្យ"], Component: load("fun", "word-cloud") },
  { id: "braille-translator", title: "Braille Translator", khmerTitle: "កម្មវិធីបកប្រែអក្សរប្រៃយ៍", addedOn: "2026-08-21T16:25:00+07:00", category: "text", keywords: ["braille", "accessibility", "unicode braille", "grade 1", "blind", "អក្សរប្រៃយ៍"], Component: load("text", "braille-translator") },
  { id: "dns-lookup", title: "Live DNS Lookup", khmerTitle: "ស្វែងរក DNS ផ្ទាល់", addedOn: "2026-08-21T17:00:00+07:00", category: "network", keywords: ["dns", "lookup", "a record", "mx", "txt", "ns", "cname", "soa", "dns over https", "domain"], Component: load("network", "dns-lookup") },
  { id: "whats-my-ip", title: "What's My IP", khmerTitle: "លេខ IP របស់ខ្ញុំ", addedOn: "2026-08-21T17:05:00+07:00", category: "network", keywords: ["my ip", "public ip", "ip address", "isp", "geo ip", "what is my ip"], Component: load("network", "whats-my-ip") },
  { id: "http-request-tester", title: "HTTP Request Tester", khmerTitle: "ឧបករណ៍សាកល្បងសំណើ HTTP", addedOn: "2026-08-21T17:10:00+07:00", category: "dev", keywords: ["http", "rest client", "api test", "request", "get post put delete", "fetch", "cors"], Component: load("dev", "http-request-tester") },
  { id: "hmac-generator", title: "HMAC Generator", khmerTitle: "បង្កើត HMAC", addedOn: "2026-08-21T17:15:00+07:00", category: "security", keywords: ["hmac", "signature", "sha256", "sha512", "web crypto", "api key signing"], Component: load("security", "hmac-generator") },
  { id: "text-to-speech", title: "Text to Speech", khmerTitle: "អត្ថបទទៅជាសំឡេង", addedOn: "2026-08-21T17:20:00+07:00", category: "audio", keywords: ["text to speech", "tts", "speak", "voice", "speech synthesis", "read aloud", "សំឡេង"], Component: load("audio", "text-to-speech") },
  { id: "images-to-gif", title: "Images to Animated GIF", khmerTitle: "រូបភាពទៅជា GIF មានចលនា", addedOn: "2026-08-21T17:25:00+07:00", category: "images", keywords: ["gif", "animated gif", "frames", "image sequence", "animation", "បង្កើត gif"], Component: load("images", "images-to-gif") },
  { id: "meme-generator", title: "Meme Generator", khmerTitle: "បង្កើតមីម", addedOn: "2026-08-21T17:30:00+07:00", category: "fun", keywords: ["meme", "caption", "impact font", "image macro", "funny", "មីម"], Component: load("fun", "meme-generator") },
  { id: "file-checksum", title: "File Checksum Verifier", khmerTitle: "ពិនិត្យកូដផ្ទៀងផ្ទាត់ឯកសារ", addedOn: "2026-08-21T18:00:00+07:00", category: "security", keywords: ["checksum", "sha256", "hash file", "verify download", "integrity", "ផ្ទៀងផ្ទាត់"], Component: load("security", "file-checksum") },
  { id: "speed-test", title: "Internet Speed Test", khmerTitle: "តេស្តល្បឿនអ៊ីនធឺណិត", addedOn: "2026-08-21T18:05:00+07:00", category: "network", keywords: ["speed test", "bandwidth", "ping", "jitter", "download upload", "cloudflare", "ល្បឿនអ៊ីនធឺណិត"], Component: load("network", "speed-test") },
  { id: "qr-batch", title: "QR Batch Generator", khmerTitle: "បង្កើត QR ជាបាច់", addedOn: "2026-08-21T18:10:00+07:00", category: "office", keywords: ["qr batch", "bulk qr", "qr codes zip", "svg", "asset tags", "inventory", "បង្កើត QR"], Component: load("office", "qr-batch") },
  { id: "curl-converter", title: "cURL → Code Converter", khmerTitle: "បម្លែង cURL ទៅជាកូដ", addedOn: "2026-08-21T18:15:00+07:00", category: "dev", keywords: ["curl", "fetch", "axios", "requests", "go http", "convert", "api"], Component: load("dev", "curl-converter") },
  { id: "markdown-toc", title: "Markdown TOC Generator", khmerTitle: "បង្កើតតារាងមាតិកា Markdown", addedOn: "2026-08-21T18:20:00+07:00", category: "dev", keywords: ["markdown", "table of contents", "toc", "anchors", "github slug", "docs"], Component: load("dev", "markdown-toc") },
  { id: "voice-dictation", title: "Voice Dictation", khmerTitle: "សរសេរដោយសំឡេង", addedOn: "2026-08-21T18:25:00+07:00", category: "audio", keywords: ["dictation", "speech to text", "voice typing", "microphone", "khmer speech", "សរសេរដោយសំឡេង"], Component: load("audio", "voice-dictation") },
  { id: "savings-goal", title: "Savings Goal Calculator", khmerTitle: "គណនាគោលដៅសន្សំ", addedOn: "2026-08-21T18:30:00+07:00", category: "math", keywords: ["savings goal", "deposit", "compound", "target", "months to save", "គោលដៅសន្សំ"], Component: load("math", "savings-goal") },
  { id: "meta-tag-generator", title: "Meta Tag Generator", khmerTitle: "បង្កើតសញ្ញាសម្គាល់ Meta", addedOn: "2026-08-21T18:35:00+07:00", category: "design", keywords: ["meta tags", "seo", "open graph", "twitter card", "head snippet", "social preview"], Component: load("design", "meta-tag-generator") },
  { id: "pregnancy-due-date", title: "Pregnancy Due Date Calculator", khmerTitle: "គណនាថ្ងៃសម្រាល", addedOn: "2026-08-21T18:40:00+07:00", category: "family", keywords: ["pregnancy", "due date", "naegele", "trimester", "gestational", "ថ្ងៃសម្រាល"], Component: load("family", "pregnancy-due-date") },
  { id: "debt-settle-up", title: "Debt Settle-Up Splitter", khmerTitle: "ការចែកចាយ និងបញ្ចុះបញ្ចូលបំណុល", addedOn: "2026-08-21T18:45:00+07:00", category: "math", keywords: ["split expenses", "settle up", "who owes whom", "trip costs", "transfers", "ចែកចំណាយ"], Component: load("math", "debt-settle-up") },
  { id: "khmer-studio", title: "Khmer Studio", khmerTitle: "ស្ទូឌីយោខ្មែរ", addedOn: "2026-08-21T19:00:00+07:00", category: "khmer", keywords: ["khmer studio", "poster", "crossword", "exam", "pdf", "kantumruy", "moul", "bokor", "noto sans khmer", "noto serif khmer", "variable font", "print", "worksheet", "happypdf", "shaping", "ស្ទូឌីយោខ្មែរ", "បោះពុម្ព"], localProject: { author: "Seanghay Yath", repository: "https://github.com/seanghay/happypdf", license: "MIT", relationship: "integrated" }, Component: load("khmer", "khmer-studio") },
  ...
  { id: "image-palette-extractor", title: "Image Palette Extractor", khmerTitle: "ស្រង់ពណ៌ពីរូបភាព", addedOn: "2026-08-21T14:15:00+07:00", category: "images", keywords: ["palette", "colors", "extract", "dominant colors", "image", "hex", "swatch", "ពណ៌", "រូបភាព"], Component: load("images", "image-palette-extractor") },
  { id: "svg-to-png", title: "SVG to PNG Converter", khmerTitle: "បម្លែង SVG ទៅជា PNG", addedOn: "2026-08-21T14:20:00+07:00", category: "images", keywords: ["svg", "png", "convert", "render", "raster", "image", "export", "បម្លែង"], Component: load("images", "svg-to-png") },
