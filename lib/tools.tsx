...
export const TOOLS: ToolDef[] = [
  ...
  { id: "deepseek-rate-desk", title: "DeepSeek V4 Rate Desk", khmerTitle: "តារាងតម្លៃ DeepSeek V4", addedOn: "2026-08-20T15:00:00+07:00", category: "dev", keywords: ["deepseek", "pricing", "api", "rate", "token cost", "llm", "peak", "off-peak", "cost calculator", "deepseek v4", "តម្លៃ"], Component: load("dev", "deepseek-rate-desk") },
  ...
  { id: "electronics-calculators", title: "Electronics Calculators", khmerTitle: "ម៉ាស៊ីនគណនាអេឡិចត្រូនិក", addedOn: "2026-08-20T13:00:00+07:00", category: "science", keywords: ["resistor", "color code", "led", "voltage divider", "ohms law", "electronics", "circuit", "ohm", "រេស៊ីស្ទ័រ", "អេឡិចត្រូនិក"], Component: load("science", "electronics-calculators") },
  { id: "one-rep-max", title: "One-Rep Max (1RM) Calculator", khmerTitle: "គណនាទម្ងន់អតិបរមា ១ដង (1RM)", addedOn: "2026-08-20T13:05:00+07:00", category: "science", keywords: ["1rm", "one rep max", "epley", "brzycki", "strength", "lifting", "gym", "weightlifting", "fitness", "លើកទម្ងន់"], Component: load("science", "one-rep-max") },
  ...
  { id: "math-symbols", title: "Math Symbol Dictionary", khmerTitle: "វចនានុក្រមសញ្ញាគណិតវិទ្យា", addedOn: "2026-08-20T12:00:00+07:00", category: "math", keywords: ["math symbols", "symbol", "latex", "unicode", "summation", "integral", "greek letters", "notation", "សញ្ញាគណិតវិទ្យា"], Component: load("math", "math-symbols") },
  { id: "formula-solver", title: "Formula Solver", khmerTitle: "ដោះស្រាយរូបមន្ត", addedOn: "2026-08-20T12:05:00+07:00", category: "math", keywords: ["formula", "solve", "area", "volume", "speed", "density", "ohms law", "pythagorean", "interest", "រូបមន្ត"], Component: load("math", "formula-solver") },
  { id: "permutation-combination", title: "Permutation & Combination Calculator", khmerTitle: "គណនាការរៀបលំដាប់ និងបន្សំ", addedOn: "2026-08-20T12:10:00+07:00", category: "math", keywords: ["permutation", "combination", "npr", "ncr", "factorial", "combinatorics", "choose"], Component: load("math", "permutation-combination") },
  { id: "complex-number", title: "Complex Number Calculator", khmerTitle: "គណនាចំនួនកុំផ្លិច", addedOn: "2026-08-20T12:15:00+07:00", category: "math", keywords: ["complex number", "imaginary", "a+bi", "modulus", "argument", "conjugate", "កុំផ្លិច"], Component: load("math", "complex-number") },
  { id: "geometry-calculator", title: "Geometry Area & Volume Calculator", khmerTitle: "គណនាផ្ទៃក្រឡា និងមាឌធរណីមាត្រ", addedOn: "2026-08-20T12:20:00+07:00", category: "math", keywords: ["area", "volume", "perimeter", "surface area", "circle", "sphere", "cylinder", "cone", "cube", "geometry"], Component: load("math", "geometry-calculator") },
  { id: "exponent-logarithm", title: "Exponent & Logarithm Solver", khmerTitle: "ដោះស្រាយស្វ័យគុណ និងលោការីត", addedOn: "2026-08-20T12:25:00+07:00", category: "math", keywords: ["exponent", "logarithm", "log", "power", "base", "e", "ln", "ស្វ័យគុណ", "លោការីត"], Component: load("math", "exponent-logarithm") },
  { id: "trig-values", title: "Trig Values Table", khmerTitle: "តារាងតម្លៃត្រីកោណមាត្រ", addedOn: "2026-08-20T12:30:00+07:00", category: "math", keywords: ["trig", "trigonometry", "sin", "cos", "tan", "unit circle", "radians", "degrees", "ត្រីកោណមាត្រ"], Component: load("math", "trig-values") },
  { id: "matrix-operations", title: "Matrix Operations Calculator", khmerTitle: "គណនាប្រតិបត្តិការម៉ាទ្រីស", addedOn: "2026-08-20T13:10:00+07:00", category: "math", keywords: ["matrix", "matrices", "add", "multiply", "inverse", "transpose", "determinant", "linear algebra", "ម៉ាទ្រីស"], Component: load("math", "matrix-operations") },
  { id: "vector-calculator", title: "Vector Calculator", khmerTitle: "ម៉ាស៊ីនគណនាវ៉ិចទ័រ", addedOn: "2026-08-20T14:00:00+07:00", category: "math", keywords: ["vector", "dot product", "cross product", "magnitude", "angle", "projection", "វ៉ិចទ័រ"], Component: load("math", "vector-calculator") },
  ...
  { id: "social-post-generator", title: "Social Post Generator", khmerTitle: "បង្កើតប៉ុស្តិ៍បណ្ដាញសង្គម", addedOn: "2026-08-20T14:30:00+07:00", category: "design", keywords: ["social post", "social media", "x", "twitter", "facebook", "telegram", "instagram", "story", "post image", "quote card", "social graphic", "បង្កើតប៉ុស្តិ៍", "បណ្ដាញសង្គម"], Component: load("design", "social-post-generator") },
  ...
  { id: "barcode-generator", title: "Barcode Generator", khmerTitle: "បង្កើតកូដបារកូដ", addedOn: "2026-08-20T14:05:00+07:00", category: "office", keywords: ["barcode", "ean", "upc", "code128", "code39", "svg", "retail", "inventory", "បារកូដ"], Component: load("office", "barcode-generator") },
  { id: "inflation-calculator", title: "Inflation Calculator", khmerTitle: "គណនាអតិផរណា", addedOn: "2026-08-20T14:10:00+07:00", category: "office", keywords: ["inflation", "purchasing power", "cpi", "price", "money", "economy", "អតិផរណា"], Component: load("office", "inflation-calculator") },
  ...
  { id: "image-palette-extractor", title: "Image Palette Extractor", khmerTitle: "ស្រង់ពណ៌ពីរូបភាព", addedOn: "2026-08-20T14:15:00+07:00", category: "images", keywords: ["palette", "colors", "extract", "dominant colors", "image", "hex", "swatch", "ពណ៌", "រូបភាព"], Component: load("images", "image-palette-extractor") },
  { id: "svg-to-png", title: "SVG to PNG Converter", khmerTitle: "បម្លែង SVG ទៅជា PNG", addedOn: "2026-08-20T14:20:00+07:00", category: "images", keywords: ["svg", "png", "convert", "render", "raster", "image", "export", "បម្លែង"], Component: load("images", "svg-to-png") },
