...
export const TOOLS: ToolDef[] = [
  ...
  { id: "screenshot-ocr", title: "Screenshot OCR", khmerTitle: "អានអត្ថបទពីរូបភាព", addedOn: "2026-08-24", category: "images", keywords: ["ocr", "screenshot", "extract", "tesseract", "khmer", "text recognition", "អានអត្ថបទ", "ចម្លង"], Component: load("images", "screenshot-ocr") },
