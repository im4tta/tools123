...
១២៣ Toolbox is a responsive collection of **424 registered tools** across **13 categories**. That total includes 228 explicitly registered tools, 193 generated unit-conversion pairs, and 3 temperature-conversion pairs. Tools are accessible from the searchable list, an interactive graph, the command palette, or direct URLs.
