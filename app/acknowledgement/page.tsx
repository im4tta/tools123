...
const LIBRARIES = [
  ...
  { name: "JsBarcode", url: "https://github.com/lindell/JsBarcode", by: "Johan Lindell", use: "Barcode (CODE128) generation in the browser" },
  { name: "html2canvas", url: "https://html2canvas.hertzen.com/", by: "Niklas von Hertzen", use: "Rendering DOM elements to canvas for PNG/card export" },
  { name: "jsPDF", url: "https://github.com/parallax/jsPDF", by: "James Hall, yWorks GmbH & contributors", use: "Client-side PDF generation (print-ready A4 sheets)" },
  { name: "Leaflet", url: "https://leafletjs.com/", by: "Volodymyr Agafonkin", use: "Interactive map for picking GPS coordinates" },
  { name: "OpenStreetMap", url: "https://www.openstreetmap.org/", by: "OpenStreetMap contributors", use: "Map tiles for the location picker" },
  { name: "Google Maps icon", url: "https://commons.wikimedia.org/wiki/File:Google_Maps_icon_(2026).svg", by: "Google", use: "Pin silhouette adapted for the Location QR center badge" },
